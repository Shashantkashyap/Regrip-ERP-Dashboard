...
function Summary({ summaryItems, handleClick, loading }) {
  const dispatch = useDispatch();

  return (
    <div className="relative w-[495px] min-w-[300px] bg-white p-[15px_15px_30px_15px] rounded-[15px] border-[1px] font-outfit cursor-pointer">
      {loading ? (
