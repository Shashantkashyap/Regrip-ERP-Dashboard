        ...
        <thead>
          <tr>
            ...
            <th className="py-2 px-4 text-left font-semibold text-[14px] leading-[16.94px] text-[#6D6D6D]">
              <div className="flex gap-1 items-center">
                <p>Vehicle No</p>
                <div onClick={() => handleFilterChange('vehicle_no')} className="cursor-pointer">
                  <IoFilterSharp />
                </div>
              </div>
            </th>
            ...
            <th className="py-2 px-4 text-left font-semibold text-[14px] leading-[16.94px] text-[#6D6D6D]">Model</th>
            <th className="py-2 px-4 text-left font-semibold text-[14px] leading-[16.94px] text-[#6D6D6D]">
              <div className="flex gap-1 items-center">
                <p>Dues</p>
                <div onClick={() => handleSort('datetime_created')} className="cursor-pointer">
