...
import InspectionTyreFitmentDetails from '../inspectionComponent/InspectionTyreFitmentDetails';
import Loader from '../common/Loader';
import { PiExportBold } from 'react-icons/pi';

function TyrePurchaseCountDetails({vehicle_id, close}) {
  ...
  return (
    ...
    <div className="flex justify-end mb-2">
      <button className="bg-[#333333] text-white text-[14px] py-2 px-4 rounded-md flex items-center gap-2 hover:bg-green-600 transition mb-2">
      ...
      <table className="min-w-full bg-white border border-gray-200 rounded-[10px]">
        <thead className="bg-gray-100 text-gray-600">
          <tr>
            ...
            <td className="py-2 px-4 text-left border-b font-outfit text-[#727272] font-normal text-[14px] leading-[21.42px]">Invoice No.</td>
            <td className="py-2 px-6 text-left border-b font-outfit text-[#727272] font-normal text-[14px] leading-[21.42px]">Invoice Date</td>
            <td className="py-2 px-2 text-left border-b font-outfit text-[#727272] font-normal text-[14px] leading-[21.42px]">Tyre Number</td>
            <td className="py-2 px-4 text-left border-b font-outfit text-[#727272] font-normal text-[14px] leading-[21.42px]">Brand</td>
            <td className="py-2 px-0 text-left border-b font-outfit text-[#727272] font-normal text-[14px] leading-[21.42px]">Model</td>
            <td className="py-2 px-2 text-left border-b font-outfit text-[#727272] font-normal text-[14px] leading-[21.42px]">Size</td>
            <td className="py-2 px-2 text-left border-b font-outfit text-[#727272] font-normal text-[14px] leading-[21.42px]">Retread/Fresh</td>
            <td className="py-2 px-2 text-left border-b font-outfit text-[#727272] font-normal text-[14px] leading-[21.42px]">Vendor Name</td>
          </tr>
        </thead>
        <tbody>
...
export default TyrePurchaseCountDetails;
